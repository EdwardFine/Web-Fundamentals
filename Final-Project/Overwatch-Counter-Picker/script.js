...
var heroes = {
    ...
    "Pharah":{ "strong_against": ["D.va","Doomfist","Junker Queen","Orisa","Ramattra","Reinhardt","Roadhog","Winston","Wrecking Ball","Zarya","Genji","Hanzo","Junkrat","Mei"],
        "weak_against": ["Sigma","Ashe","Bastion","Cassidy","Echo"]},
    "Reaper":{ "strong_against": ["D.va","Doomfist","Orisa","Ramattra","Reinhardt","Roadhog","Sigma","Winston","Zarya","Bastion","Cassidy","Mei"],
        "weak_against": ["Junker Queen","Wrecking Ball","Ashe","Echo","Genji","Hanzo","Junkrat"]},
    "Sojourn":{ "strong_against": ["Junker Queen","Orisa","Reinhardt","Roadhog","Wrecking Ball","Zarya","Ashe","Bastion","Cassidy","Echo","Genji","Hanzo","Junkrat","Mei"],
        "weak_against": ["D.va","Doomfist","Ramattra","Sigma","Winston"]},
    "Soldier: 76":{ "strong_against": ["Junker Queen","Orisa","Reinhardt","Roadhog","Wrecking Ball","Zarya","Bastion","Echo","Junkrat","Mei"],
        "weak_against": ["D.va","Doomfist","Ramattra","Sigma","Winston","Ashe","Cassidy","Genji","Hanzo"]},
    "Sombra":{ "strong_against": ["Doomfist","Junker Queen","Orisa","Ramattra","Reinhardt","Sigma","Wrecking Ball","Ashe","Bastion","Cassidy","Echo","Genji","Junkrat"],
        "weak_against": ["D.va","Roadhog","Winston","Zarya","Hanzo","Mei"]},
    "Symmetra":{ "strong_against": ["D.va","Doomfist","Junker Queen","Reinhardt","Sigma","Wrecking Ball","Bastion","Genji","Hanzo"],
        "weak_against": ["Orisa","Ramattra","Roadhog","Winston","Zarya","Ashe","Cassidy","Echo","Junkrat","Mei"]},
    "Torbjörn":{ "strong_against": ["D.va","Junker Queen","Orisa","Reinhardt","Roadhog","Winston","Wrecking Ball","Echo","Genji"],
        "weak_against": ["Doomfist","Ramattra","Sigma","Zarya","Ashe","Bastion","Cassidy","Hanzo","Junkrat","Mei"]},
    "Tracer":{ "strong_against": ["Doomfist","Orisa","Roadhog","Sigma","Wrecking Ball","Bastion","Hanzo"],
        "weak_against": ["D.va","Junker Queen","Ramattra","Reinhardt","Roadhog","Winston","Zarya","Ashe","Cassidy","Echo","Genji","Junkrat","Mei"]},
    "Widowmaker":{ "strong_against": ["Junker Queen","Orisa","Roadhog","Zarya","Bastion","Cassidy","Junkrat"],
        "weak_against": ["D.va","Doomfist","Ramattra","Reinhardt","Sigma","Winston","Wrecking Ball","Ashe","Echo","Genji","Hanzo","Mei"]},
    "Ana":{ "strong_against": ["Doomfist","Junker Queen","Orisa","Ramattra","Reinhardt","Roadhog","Sigma","Wrecking Ball","Bastion","Echo"],
        "weak_against": ["D.va","Winston","Zarya","Ashe","Cassidy","Genji","Hanzo","Junkrat","Mei"]},
    "Baptiste":{ "strong_against": ["Doomfist","Junker Queen","Orisa","Reinhardt","Sigma","Winston","Wrecking Ball","Cassidy","Echo","Junkrat","Mei"],
        "weak_against": ["D.va","Ramattra","Roadhog","Zarya","Ashe","Bastion","Genji","Hanzo"]},
    "Brigitte":{ "strong_against": ["D.va","Doomfist","Reinhardt","Winston","Wrecking Ball","Mei"],
        "weak_against": ["Junker Queen","Orisa","Ramattra","Roadhog","Sigma","Zarya","Ashe","Bastion","Cassidy","Echo","Genji","Hanzo","Junkrat"]}, 
    "Kiriko":{ "strong_against": ["D.va","Doomfist","Junker Queen","Orisa","Ramattra","Reinhardt","Roadhog","Winston","Wrecking Ball","Zarya","Bastion","Cassidy","Junkrat","Mei"],
        "weak_against": ["Sigma","Ashe","Echo","Genji","Hanzo"]}, 
    "Lifeweaver":{ "strong_against": ["Doomfist","Junker Queen","Reinhardt","Roadhog","Sigma","Wrecking Ball","Zarya"],
        "weak_against": ["D.va","Orisa","Ramattra","Winston","Ashe","Bastion","Cassidy","Echo","Genji","Hanzo","Junkrat","Mei"]},
    "Lúcio":{ "strong_against": ["D.va","Doomfist","Junker Queen","Reinhardt","Sigma","Ashe","Bastion","Genji","Hanzo","Junkrat"],
        "weak_against": ["Orisa","Ramattra","Roadhog","Winston","Wrecking Ball","Zarya","Cassidy","Echo","Mei"]},
    "Mercy":{ "strong_against": ["Junker Queen","Ramattra","Reinhardt","Wrecking Ball","Ashe","Bastion","Hanzo","Junkrat","Mei"],
        "weak_against": ["D.va","Doomfist","Orisa","Roadhog","Sigma","Winston","Zarya","Cassidy","Echo","Genji"]},
    "Moira":{ "strong_against": ["D.va","Doomfist","Junker Queen","Ramattra","Wrecking Ball","Ashe","Bastion","Cassidy","Echo","Genji","Junkrat"],
        "weak_against": ["Orisa","Reinhardt","Roadhog","Sigma","Winston","Zarya","Hanzo","Mei"]},
    "Zenyatta":{ "strong_against": ["D.va","Orisa","Ramattra","Roadhog","Sigma","Winston","Ashe","Bastion","Cassidy","Genji","Mei"],
        "weak_against": ["Doomfist","Junker Queen","Reinhardt","Wrecking Ball","Zarya","Echo","Hanzo","Junkrat"]}
}
