...
var heroes = {
    ...
    "Tracer":{ "strong_against": ["Doomfist","Orisa","Roadhog","Sigma","Wrecking Ball","Bastion","Hanzo","Reaper","Torbjörn","Tracer","Widowmaker","Ana","Lúcio","Mercy","Zenyatta"],
        "weak_against": ["D.va","Junker Queen","Ramattra","Reinhardt","Roadhog","Winston","Zarya","Ashe","Cassidy","Echo","Genji","Junkrat","Mei","Pharah","Sojourn","Symmetra","Baptiste","Brigitte","Kiriko","Lifeweaver","Moira"]},
    "Widowmaker":{ "strong_against": ["Junker Queen","Orisa","Roadhog","Zarya","Bastion","Cassidy","Junkrat","Pharah","Reaper","Symmetra","Torbjörn","Widowmaker","Ana","Baptiste","Lifeweaver","Mercy","Zenyatta"],
        "weak_against": ["D.va","Doomfist","Ramattra","Reinhardt","Sigma","Winston","Wrecking Ball","Ashe","Echo","Genji","Hanzo","Mei","Sojourn","Tracer","Brigitte","Kiriko","Lúcio","Moira"]},
    "Ana":{ "strong_against": ["Doomfist","Junker Queen","Orisa","Ramattra","Reinhardt","Roadhog","Sigma","Wrecking Ball","Bastion","Echo","Pharah","Symmetra","Torbjörn","Ana","Baptiste","Brigitte","Mercy","Zenyatta"],
        "weak_against": ["D.va","Winston","Zarya","Ashe","Cassidy","Genji","Hanzo","Junkrat","Mei","Reaper","Sojourn","Tracer","Kiriko","Lifeweaver","Lúcio","Moira"]},
    "Baptiste":{ "strong_against": ["Doomfist","Junker Queen","Orisa","Reinhardt","Sigma","Winston","Wrecking Ball","Cassidy","Echo","Junkrat","Mei","Pharah","Torbjörn","Tracer","Baptiste","Brigitte","Kiriko","Lifeweaver","Lúcio","Mercy","Moira"],
        "weak_against": ["D.va","Ramattra","Roadhog","Zarya","Ashe","Bastion","Genji","Hanzo","Reaper","Sojourn","Symmetra","Widowmaker","Ana","Zenyatta"]},
    "Brigitte":{ "strong_against": ["D.va","Doomfist","Reinhardt","Winston","Wrecking Ball","Mei","Reaper","Tracer","Brigitte","Lúcio","Moira"],
        "weak_against": ["Junker Queen","Orisa","Ramattra","Roadhog","Sigma","Zarya","Ashe","Bastion","Cassidy","Echo","Genji","Hanzo","Junkrat","Pharah","Sojourn","Symmetra","Torbjörn","Widowmaker","Ana","Baptiste","Kiriko","Lifeweaver","Mercy","Zenyatta"]}, 
    "Kiriko":{ "strong_against": ["D.va","Doomfist","Junker Queen","Orisa","Ramattra","Reinhardt","Roadhog","Winston","Wrecking Ball","Zarya","Bastion","Cassidy","Junkrat","Mei","Symmetra","Torbjörn","Tracer","Ana","Brigitte","Kiriko","Lifeweaver","Moira"],
        "weak_against": ["Sigma","Ashe","Echo","Genji","Hanzo","Pharah","Reaper","Sojourn","Baptiste","Lúcio","Mercy","Zenyatta"]}, 
    "Lifeweaver":{ "strong_against": ["Doomfist","Junker Queen","Reinhardt","Roadhog","Sigma","Wrecking Ball","Zarya","Reaper","Torbjörn","Tracer","Ana","Brigitte","Lifeweaver","Moira"],
        "weak_against": ["D.va","Orisa","Ramattra","Winston","Ashe","Bastion","Cassidy","Echo","Genji","Hanzo","Junkrat","Mei","Pharah","Sojourn","Symmetra","Widowmaker","Baptiste","Kiriko","Lúcio","Mercy","Zenyatta"]},
    "Lúcio":{ "strong_against": ["D.va","Doomfist","Junker Queen","Reinhardt","Sigma","Ashe","Bastion","Genji","Hanzo","Junkrat","Reaper","Sojourn","Widowmaker","Ana","Kiriko","Lifeweaver","Zenyatta"],
        "weak_against": ["Orisa","Ramattra","Roadhog","Winston","Wrecking Ball","Zarya","Cassidy","Echo","Mei","Pharah","Symmetra","Torbjörn","Tracer","Baptiste","Brigitte","Lúcio","Mercy","Moira"]},
    "Mercy":{ "strong_against": ["Junker Queen","Ramattra","Reinhardt","Wrecking Ball","Ashe","Bastion","Hanzo","Junkrat","Mei","Reaper","Sojourn","Symmetra","Brigitte","Kiriko","Lifeweaver","Lúcio"],
        "weak_against": ["D.va","Doomfist","Orisa","Roadhog","Sigma","Winston","Zarya","Cassidy","Echo","Genji","Pharah","Torbjörn","Tracer","Widowmaker","Ana","Baptiste","Mercy","Moira","Zenyatta"]},
    "Moira":{ "strong_against": ["D.va","Doomfist","Junker Queen","Ramattra","Wrecking Ball","Ashe","Bastion","Cassidy","Echo","Genji","Junkrat","Reaper","Sojourn","Tracer","Widowmaker","Ana","Lúcio","Mercy"],
        "weak_against": ["Orisa","Reinhardt","Roadhog","Sigma","Winston","Zarya","Hanzo","Mei","Pharah","Symmetra","Torbjörn","Baptiste","Brigitte","Kiriko","Lifeweaver","Moira","Zenyatta"]},
    "Zenyatta":{ "strong_against": ["D.va","Orisa","Ramattra","Roadhog","Sigma","Winston","Ashe","Bastion","Cassidy","Genji","Mei","Symmetra","Torbjörn","Baptiste","Brigitte","Kiriko","Lifeweaver","Mercy","Moira","Zenyatta"],
        "weak_against": ["Doomfist","Junker Queen","Reinhardt","Wrecking Ball","Zarya","Echo","Hanzo","Junkrat","Pharah","Reaper","Sojourn","Tracer","Widowmaker","Ana","Lúcio"]}
}
