...
var heroes = {
    ...
    "Ramattra":{ "counters": ["D.va","Junker Queen"],
        "countered_by": ["Doomfist","Orisa"],
        "counter_each_other": [], "no_effect": [] },
    "Reinhardt":{ "counters": ["Doomfist","Junker Queen"],
        "countered_by": ["D.va","Orisa"],
        "counter_each_other": [], "no_effect": [] },
    "Roadhog":{ "counters": ["Doomfist"],
        "countered_by": ["Junker Queen","Orisa"],
        "counter_each_other": ["D.va"], "no_effect": [] },
    "Sigma":{ "counters": ["D.va","Junker Queen"],
        "countered_by": ["Doomfist","Orisa"],
        "counter_each_other": [], "no_effect": [] },
    "Winston":{ "counters": [],
        "countered_by": ["Doomfist","Junker Queen","Orisa"],
        "counter_each_other": ["D.va"], "no_effect": [] },
    "Wrecking Ball":{ "counters": [],
        "countered_by": ["D.va","Doomfist","Junker Queen","Orisa"],
        "counter_each_other": [], "no_effect": [] },
    "Zarya":{ "counters": ["D.va","Doomfist","Junker Queen","Orisa"],
        "countered_by": [],
        "counter_each_other": [], "no_effect": [] },
    "Ashe":{ "counters": ["Doomfist","Junker Queen","Orisa"],
        "countered_by": ["D.va"],
        "counter_each_other": [], "no_effect": [] },
    "Bastion":{ "counters": ["Doomfist","Junker Queen","Orisa"],
        "countered_by": ["D.va"],
        "counter_each_other": [], "no_effect": [] },
    "Cassidy":{ "counters": ["Doomfist","Junker Queen"],
        "countered_by": ["D.va"],
        "counter_each_other": ["Orisa"], "no_effect": [] },
    "Echo":{ "counters": ["D.va","Doomfist","Junker Queen","Orisa"],
        "countered_by": [],
        "counter_each_other": [], "no_effect": [] },
    "Genji":{ "counters": ["D.va","Orisa"],
        "countered_by": ["Junker Queen"],
        "counter_each_other": ["Doomfist"], "no_effect": [] },
    "Hanzo":{ "counters": ["Doomfist","Junker Queen","Orisa"],
        "countered_by": ["D.va"],
        "counter_each_other": [], "no_effect": [] },
    ...
    "Mei":{ "counters": ["D.va","Doomfist","Junker Queen"],
        "countered_by": ["Orisa"],
        "counter_each_other": [], "no_effect": [] },
    "Pharah":{ "counters": ["D.va","Doomfist","Junker Queen","Orisa"],
        "countered_by": [],
        "counter_each_other": [], "no_effect": [] },
    "Reaper":{ "counters": ["D.va","Doomfist","Orisa"],
        "countered_by": ["Junker Queen"],
        "counter_each_other": [], "no_effect": [] },
    "Sojourn":{ "counters": ["Junker Queen","Orisa"],
        "countered_by": ["D.va","Doomfist"],
        "counter_each_other": [], "no_effect": [] },
    "Soldier: 76":{ "counters": ["Junker Queen","Orisa"],
        "countered_by": ["D.va","Doomfist"],
        "counter_each_other": [], "no_effect": [] },
    "Sombra":{ "counters": ["Doomfist","Junker Queen","Orisa"],
        "countered_by": ["D.va"],
        "counter_each_other": [], "no_effect": [] },
    "Symmetra":{ "counters": ["D.va","Doomfist","Junker Queen"],
        "countered_by": ["Orisa"],
        "counter_each_other": [], "no_effect": [] },
    "Torbjörn":{ "counters": ["D.va","Junker Queen","Orisa"],
        "countered_by": ["Doomfist"],
        "counter_each_other": [], "no_effect": [] },
    "Tracer":{ "counters": ["Doomfist","Orisa"],
        "countered_by": ["D.va"],
        "counter_each_other": ["Junker Queen"], "no_effect": [] },
    "Widowmaker":{ "counters": ["Junker Queen","Orisa"],
        "countered_by": ["D.va","Doomfist"],
        "counter_each_other": [], "no_effect": [] },
    "Ana":{ "counters": ["Doomfist","Junker Queen","Orisa"],
        "countered_by": [],
        "counter_each_other": ["D.va"], "no_effect": [] },
    "Baptiste":{ "counters": ["Doomfist","Junker Queen","Orisa"],
        "countered_by": ["D.va"],
        "counter_each_other": [], "no_effect": [] },
    "Brigitte":{ "counters": ["D.va","Doomfist"],
        "countered_by": ["Junker Queen","Orisa"],
        "counter_each_other": [], "no_effect": [] }, 
    "Kiriko":{ "counters": ["D.va","Doomfist","Junker Queen","Orisa"],
        "countered_by": [],
        "counter_each_other": [], "no_effect": [] }, 
    ...
    "Lúcio":{ "counters": ["D.va","Doomfist","Junker Queen"],
        "countered_by": ["Orisa"],
        "counter_each_other": [], "no_effect": [] },
    "Mercy":{ "counters": ["Junker Queen"],
        "countered_by": ["D.va","Doomfist","Orisa"],
        "counter_each_other": [], "no_effect": [] },
    "Moira":{ "counters": ["D.va","Doomfist","Junker Queen"],
        "countered_by": ["Orisa"],
        "counter_each_other": [], "no_effect": [] },
    "Zenyatta":{ "counters": ["D.va","Orisa"],
