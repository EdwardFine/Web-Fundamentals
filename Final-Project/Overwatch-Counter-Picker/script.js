...
var heroes = {
    ...
    "Symmetra":{ "strong_against": ["D.va","Doomfist","Junker Queen","Reinhardt","Sigma","Wrecking Ball","Bastion","Genji","Hanzo","Reaper"],
        "weak_against": ["Orisa","Ramattra","Roadhog","Winston","Zarya","Ashe","Cassidy","Echo","Junkrat","Mei","Pharah","Sojourn"]},
    "Torbjörn":{ "strong_against": ["D.va","Junker Queen","Orisa","Reinhardt","Roadhog","Winston","Wrecking Ball","Echo","Genji","Reaper"],
        "weak_against": ["Doomfist","Ramattra","Sigma","Zarya","Ashe","Bastion","Cassidy","Hanzo","Junkrat","Mei","Pharah","Sojourn"]},
    "Tracer":{ "strong_against": ["Doomfist","Orisa","Roadhog","Sigma","Wrecking Ball","Bastion","Hanzo","Reaper"],
        "weak_against": ["D.va","Junker Queen","Ramattra","Reinhardt","Roadhog","Winston","Zarya","Ashe","Cassidy","Echo","Genji","Junkrat","Mei","Pharah","Sojourn"]},
    "Widowmaker":{ "strong_against": ["Junker Queen","Orisa","Roadhog","Zarya","Bastion","Cassidy","Junkrat","Pharah","Reaper"],
        "weak_against": ["D.va","Doomfist","Ramattra","Reinhardt","Sigma","Winston","Wrecking Ball","Ashe","Echo","Genji","Hanzo","Mei","Sojourn"]},
    "Ana":{ "strong_against": ["Doomfist","Junker Queen","Orisa","Ramattra","Reinhardt","Roadhog","Sigma","Wrecking Ball","Bastion","Echo","Pharah"],
        "weak_against": ["D.va","Winston","Zarya","Ashe","Cassidy","Genji","Hanzo","Junkrat","Mei","Reaper","Sojourn"]},
    "Baptiste":{ "strong_against": ["Doomfist","Junker Queen","Orisa","Reinhardt","Sigma","Winston","Wrecking Ball","Cassidy","Echo","Junkrat","Mei","Pharah"],
        "weak_against": ["D.va","Ramattra","Roadhog","Zarya","Ashe","Bastion","Genji","Hanzo","Reaper","Sojourn"]},
    "Brigitte":{ "strong_against": ["D.va","Doomfist","Reinhardt","Winston","Wrecking Ball","Mei","Reaper"],
        "weak_against": ["Junker Queen","Orisa","Ramattra","Roadhog","Sigma","Zarya","Ashe","Bastion","Cassidy","Echo","Genji","Hanzo","Junkrat","Pharah","Sojourn"]}, 
    ...
    "Lifeweaver":{ "strong_against": ["Doomfist","Junker Queen","Reinhardt","Roadhog","Sigma","Wrecking Ball","Zarya","Reaper"],
        "weak_against": ["D.va","Orisa","Ramattra","Winston","Ashe","Bastion","Cassidy","Echo","Genji","Hanzo","Junkrat","Mei","Pharah","Sojourn"]},
    "Lúcio":{ "strong_against": ["D.va","Doomfist","Junker Queen","Reinhardt","Sigma","Ashe","Bastion","Genji","Hanzo","Junkrat","Reaper","Sojourn"],
        "weak_against": ["Orisa","Ramattra","Roadhog","Winston","Wrecking Ball","Zarya","Cassidy","Echo","Mei","Pharah"]},
    "Mercy":{ "strong_against": ["Junker Queen","Ramattra","Reinhardt","Wrecking Ball","Ashe","Bastion","Hanzo","Junkrat","Mei","Reaper","Sojourn"],
        "weak_against": ["D.va","Doomfist","Orisa","Roadhog","Sigma","Winston","Zarya","Cassidy","Echo","Genji","Pharah"]},
    "Moira":{ "strong_against": ["D.va","Doomfist","Junker Queen","Ramattra","Wrecking Ball","Ashe","Bastion","Cassidy","Echo","Genji","Junkrat","Reaper","Sojourn"],
        "weak_against": ["Orisa","Reinhardt","Roadhog","Sigma","Winston","Zarya","Hanzo","Mei","Pharah"]},
