...
const triNodeList = new DoublyLinkedList().insertAtBack(1).insertAtBack(2).insertAtBack(3).insertAtBack(1).insertAtBack(2).insertAtBack(3).insertAtBack(1).insertAtBack(2).insertAtBack(3);
const triNodeListFront = new DoublyLinkedList().insertAtFront(1).insertAtFront(2).insertAtFront(3);
